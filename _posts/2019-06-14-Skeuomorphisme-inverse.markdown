...
Un objet d'une simplicité déconcertante.
...
La 'bonne chose' à faire, le bon geste était de passer la main devant le système de façon à débloquer la porte via un détecteur de mouvement. Ce principe de survol n'est pas sans rappeler celui du 'hover' en HTML, si ce n'est pas un emprunt, ça y ressemble de très près.

Un emprunt assez maladroit selon moi et qui n'est pas sans rappeler les premiers skeuomorphes qui calquaient une réalité vers une autre. Par ce petit objet, il y a peut-être une tentative timide (et bon marché) de 'numériser' un habitat collectif.
